...
const profileEntries: Array<[id: string, layout: PreviewLayout, label: string]> = [
  ...
  ['ipwhois-lookup', 'data-table', 'IP.SB geolocation network card'],
  ['newton-math-solver', 'data-table', 'Math expression result card'],
  ['gutendex-books', 'research-library', 'Open Library subject collection'],
  ['datamuse-rhymes', 'data-table', 'Word relation result list'],
  ['open5e-monster-search', 'data-table', 'D&D monster stat board'],
