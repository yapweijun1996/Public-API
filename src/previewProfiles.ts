...
const profileEntries: Array<[id: string, layout: PreviewLayout, label: string]> = [
  ...
  ['opencitations-index', 'data-table', 'Citation network metrics'],
  ...
  ['geoboundaries-admin-boundaries', 'location-map', 'Administrative boundary map'],
  ...
  ['hdx-humanitarian-datasets', 'data-table', 'Humanitarian dataset discovery search'],
  ['open-meteo-climate', 'market-chart', 'Climate model projection comparison'],
  ['models-dev', 'data-table', 'AI model capability comparison'],
  ...
  ['pub-dev', 'developer-feed', 'Dart and Flutter package registry search'],
