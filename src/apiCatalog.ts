...
const verifiedThirdExpansionApis: ApiDemo[] = [
  ...
  {
    id: 'ipwhois-lookup', name: 'IP.SB Geolocation', provider: 'IP.SB', category: 'Developer',
    description: 'Look up an IP address\'s country, region, city, timezone, ASN, and network provider.',
    documentationUrl: 'https://ip.sb/api/', accent: '#0f766e', monogram: 'GEO',
    ...
    buildUrl: ({ ip = '8.8.8.8' }) => `https://api.ip.sb/geoip/${encode(ip || '8.8.8.8')}`,
  },
  {
  ...
  {
    id: 'gutendex-books', name: 'Open Library Subject Explorer', provider: 'Open Library', category: 'Books',
    description: 'Browse curated book collections by subject with titles, authors, edition counts, and first-publication years.',
    documentationUrl: 'https://openlibrary.org/developers/api', accent: '#5a3e2b', monogram: 'PG',
    fields: [{ id: 'subject', label: 'Subject', type: 'select', defaultValue: 'classics', help: 'Choose a book subject collection.', options: [{ label: 'Classics', value: 'classics' }, { label: 'Science Fiction', value: 'science_fiction' }, { label: 'Fantasy', value: 'fantasy' }, { label: 'History', value: 'history' }] }],
    buildUrl: ({ subject = 'classics' }) => `https://openlibrary.org/subjects/${encode(subject || 'classics')}.json?limit=8`,
  },
  {
  ...
  {
    id: 'open5e-monster-search', name: 'D&D 5e Monster Lookup', provider: 'D&D 5e API', category: 'Games',
    description: 'Inspect a Dungeons & Dragons 5e monster stat block with armor class, hit points, movement, challenge rating, and actions.',
    documentationUrl: 'https://www.dnd5eapi.co/docs/', accent: '#166534', monogram: 'O5E',
    fields: [{ id: 'monster', label: 'Monster', type: 'select', defaultValue: 'young-red-dragon', help: 'Choose a representative monster profile.', options: [{ label: 'Young Red Dragon', value: 'young-red-dragon' }, { label: 'Adult Black Dragon', value: 'adult-black-dragon' }, { label: 'Beholder', value: 'beholder' }, { label: 'Owlbear', value: 'owlbear' }] }],
    buildUrl: ({ monster = 'young-red-dragon' }) => `https://www.dnd5eapi.co/api/2014/monsters/${encode(monster || 'young-red-dragon')}`,
  },
  {
